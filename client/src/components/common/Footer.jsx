        ...
        <footer className="bg-richblack-800">
            <div className="flex lg:flex-row gap-8 items-center justify-between w-11/12 max-w-maxContent text-richblack-400 leading-6 mx-auto relative py-14">
                <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
                    ...
                    <section className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
                        <div className="w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0">

                            <img src={Logo} alt="volted logo" className="object-contain" />
                            ...
                            <div className="flex gap-3 text-lg">
                                <a href="https://www.linkedin.com/in/volted-academy/"><FaLinkedin className="hover:fill-[#0A66C2]" /></a>
                                <a href="https://twitter.com/volted_academy"><FaTwitter className="hover:fill-[#1D9BF0]" /></a>
                                <a href="https://www.youtube.com/@volted_academy"><FaYoutube className="hover:fill-[#FF0000]" /></a>
                            </div>
                        </div>
                    ...
                    <section className="lg:w-[50%] flex flex-wrap flex-row justify-between pl-3 lg:pl-5 gap-3">
            ...
            <div className="flex flex-row items-center justify-between w-11/12 max-w-maxContent text-richblack-400 mx-auto  pb-14 text-sm">
                ...
                <section className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
                    ...
                    <div className="text-center">Made with ❤️ by <a href="https://www.youtube.com/@codeSculptors" className="hover:underline hover:text-amaranth-500 focus:text-amaranth-500 focus:underline text-white">Code Sculptors </a> © 2023 Volted</div>
                </section>
            </div>
        </footer>
    );
